...
const TopStat = (props) => {
    ...
    const topCustomers = []
    const allCustomers = bills.reduce((accu, current) => {
    ...
    const topProducts = []
    const productsCount = {}
    const allBoughtProducts = bills.reduce((accu, current) => {
        ...
        <div className="d-flex flex-wrap">
            <div className="card" style={{width:'45%', margin:'10px'}}>
                <div className="card-body">
                    <h5 className="card-subtitle text-muted">Top  5 Customers</h5>
            ...
            <div className="card" style={{width:'45%', margin:'10px'}}>
            <div className="card-body">
                    <h5 className="card-subtitle text-muted">Top  5 frequently bought products</h5>
                    <table className="table table-bordered table-striped mt-3">
                        <thead>
                            <tr>
                                <th>Name</th>
